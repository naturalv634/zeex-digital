  ...
  const fetchAll = async () => {
    try {
      const [sR, pR, aR, mR, tR, repR] = await Promise.all([
        fetch('https://zeex-digital-production.up.railway.app/api/stats'),
        fetch('https://zeex-digital-production.up.railway.app/api/projects'),
        fetch('https://zeex-digital-production.up.railway.app/api/activity?limit=10'),
        ...
        fetch('https://zeex-digital-production.up.railway.app/api/reports/overview'),
      ]);
