            ...
            return (
              <div key={project.id} className="hover-lift" style={{
                ...
                <div style={{ paddingLeft: '32px' }}>
                  <a href={`/editor/projects/${project.id}`} style={{ color: C.text, fontSize: '15px', fontWeight: '700', marginBottom: '4px', display: 'block', lineHeight: 1.3 }}
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 'auto', paddingLeft: '32px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px' }}>
                    <a href={`/editor/projects/${project.id}`} style={{ backgroundColor: 'rgba(0,214,143,0.1)', color: C.green, padding: '5px 12px', borderRadius: '8px', fontSize: '12px', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '4px' }}>
                      <Eye size={12} /> View
                    </a>
                  </div>
                </div>
            ...
            {filtered.map((p, i) => {
              ...
              return (
                <div key={p.id} style={{
                  ...
                  <div>
                    <a href={`/editor/projects/${p.id}`} style={{ color: C.text, fontSize: '13.5px', fontWeight: '600' }}>{p.name}</a>
